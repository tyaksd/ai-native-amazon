        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <SignedOut>
            <SignInButton mode="modal">
              <button className="inline-flex items-center rounded-md border border-white/20 bg-white/10 px-4 py-2 text-sm text-gray-300 hover:border-gray-400 hover:bg-white/20 hover:border-white/30">
                Login
              </button>
            </SignInButton>
