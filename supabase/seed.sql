...
INSERT INTO products (id, name, images, price, brand_id, description, category, colors) VALUES 
  ...
  ('11111111-1111-1111-1111-111111111112', 'Sand Drift Tee', ARRAY['/clothingsample.png'], 80.00, '11111111-1111-1111-1111-111111111111', 'Soft cotton tee with relaxed fit and earthy tones.', 'Men', ARRAY['sand', 'beige', 'cream']),
  ('22222222-2222-2222-2222-222222222223', 'River Flow Tee', ARRAY['/clothingsample.png'], 90.00, '22222222-2222-2222-2222-222222222222', 'Flowing cotton tee with fluid silhouette and natural drape.', 'Women', ARRAY['blue', 'teal', 'navy']),
  ('33333333-3333-3333-3333-333333333334', 'Mountain Peak Hoodie', ARRAY['/clothingsample.png'], 120.00, '33333333-3333-3333-3333-333333333333', 'Heavyweight fleece hoodie with mountain-inspired design.', 'Men', ARRAY['charcoal', 'olive', 'black']),
  ('44444444-4444-4444-4444-444444444444', 'Ocean Wave Dress', ARRAY['/clothingsample.png'], 95.00, '11111111-1111-1111-1111-111111111111', 'Flowing midi dress with wave-like pleats and organic movement.', 'Women', ARRAY['navy', 'teal', 'white']),
  ('55555555-5555-5555-5555-555555555555', 'Forest Trail Pants', ARRAY['/clothingsample.png'], 85.00, '22222222-2222-2222-2222-222222222222', 'Utility pants with cargo pockets and durable construction.', 'Men', ARRAY['olive', 'khaki', 'brown']);